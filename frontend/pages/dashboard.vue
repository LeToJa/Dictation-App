<template>
    <NuxtLayout>
        ...
        <div class="mt-8">
            ...
            <div v-if="filesStore.loading && filesStore.files.length === 0" class="text-center py-12">
                <p class="text-gray-600">Cargando archivos...</p>
            </div>
            <div v-else-if="filesStore.files.length === 0" class="text-center py-12 bg-gray-50 rounded-lg">
